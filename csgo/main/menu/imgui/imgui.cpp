...
- I integrated Dear ImGui in my hotkeyengine and some elements are clipping or disappearing when I move windows around..
...
- Portable, minimize misc, run on target (consoles, phones, etc.)
...
bool ImGui::MyColorEdit3(const char* label, float col[3], ImGuiColorEditFlags flags)
{
	return false;
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	*/
	...
	if (*v)
	{
		...
		RenderCheckMark2(check_bb.Min + ImVec2(pad, pad), GetColorU32(ImGuiCol_CheckMark), square_sz - pad * 2.0f);
	}
