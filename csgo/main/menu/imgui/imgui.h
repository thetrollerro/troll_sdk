...
// Lightweight std::vector<> like class to avoid dragging misc (also: windows implementation of STL with debug enabled is absurdly slow, so let's bypass it so our code runs fast in debug).
