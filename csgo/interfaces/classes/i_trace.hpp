...
public:
	...
	explicit trace_filter( c_base_entity* player, trace_type_t tracetype = trace_everything )
	{
		skip = player;
	}
...
public:
	...
	virtual void clip_ray_to_entity( const ray_t& ray, unsigned int mask, c_base_entity* ent, trace_t* engine_trace ) = 0;
