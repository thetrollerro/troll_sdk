...
public:
	...
	//virtual void                tracepaintsurface( const model_t *model, const vec3_t& position, float radius, CUtlVector<Color>& surfColors ) = 0;
	...
	i_net_channel* get_net_channel( ) // i wanna fucking die
	{
		...
		return utilities::call_virtual<fn>( this, 78 )( this );
	}
};